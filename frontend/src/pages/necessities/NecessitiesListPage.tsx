...
import { NecessityList } from '@/features/necessities'
import {
  EmptyState,
  ErrorState,
  LoadingState,
...
export function NecessitiesListPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="Terreno"
        title="Necesidades"
        description="Visualiza prioridades en terreno y gestiona las necesidades reportadas."
        actions={
